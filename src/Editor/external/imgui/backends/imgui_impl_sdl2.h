...
// changed by me
#include "Editor/external/imgui/imgui.h"     // IMGUI_IMPL_API
...
IMGUI_IMPL_API bool     ImGui_ImplSDL2_InitForSDLRenderer(SDL_Window* window, SDL_Renderer* forwardRenderer);
